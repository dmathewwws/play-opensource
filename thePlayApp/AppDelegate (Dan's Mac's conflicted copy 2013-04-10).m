...
#define TWITTER_CONSUMER_KEY @"sSyHNPwlE9WiNcvHetyQag"
#define TWITTER_CONSUMER_SECRET @"hMdGRNI1bLgw1znPnOZWX3ONocPEDKxdbOzNehpgA8"
#define FACEBOOK_APP_ID @"113210685512131"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [Parse setApplicationId:@"W5HDVrfxd8jXzmNjkNLxYn2dDlzkncFcULjsT6gC"
                  clientKey:@"AbThSxBciw8RD6YuWMvBYXj1GZe6G4b55ALQR1A3"];
    ...
    [[UIBarButtonItem appearance] setTintColor:[UIColor colorWithRed:70.0f/255.0f green:70.0f/255.0f blue:70.0f/255.0f alpha:1.0f]];

    [[UIBarButtonItem appearance] setBackButtonBackgroundImage:[UIImage imageNamed:@"refreshbutton.png"] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
...
-(void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region{
    ...
    [event fetchIfNeededInBackgroundWithBlock:^(PFObject *object, NSError *error) {
        ...
        if ([[object valueForKey:kPlayEventTimeKey] compare:[[NSDate date]dateByAddingTimeInterval:(-60*30)]] == NSOrderedDescending){
            return;
